...
String serverName = "http://api.thingspeak.com/update?api_key=XHF3QTMI01HM41R6";  // URL do ThingSpeak. 
                                                                                  //Troque a api key pela sua
...
void loop() {
  ...
  if ((millis() - lastTime) > updateTime) 
  {
    ...
    if(WiFi.status()== WL_CONNECTED)
    {
      ...
      //Monta a URL com os dados para enviar para o ThingSpeak
      String serverPath = serverName + "&field1=" + String(temp);
