...
int valor = 0;
UBaseType_t uxHighWaterMark;  //Variável para armazenar o valor do High Water Mark
...
void loop() {
  ...
  Serial.println("------Status das Tasks------");
  uxHighWaterMark = uxTaskGetStackHighWaterMark(task1Handle);
  Serial.print(pcTaskGetTaskName(task1Handle));
  Serial.print(" : ");
  Serial.println(uxHighWaterMark);

  uxHighWaterMark = uxTaskGetStackHighWaterMark(task2Handle);
  Serial.print(pcTaskGetTaskName(task2Handle));
  Serial.print(" : ");
  Serial.println(uxHighWaterMark);

  uxHighWaterMark = uxTaskGetStackHighWaterMark(task3Handle);
  Serial.print(pcTaskGetTaskName(task3Handle));
  Serial.print(" : ");
  Serial.println(uxHighWaterMark);
  Serial.println("----------------------------");
